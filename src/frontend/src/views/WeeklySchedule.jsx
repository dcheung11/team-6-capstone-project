...
//   // **Dummy data that updates each week**
//   const matchData = {
//     "Week 1": {
//       Sunday: "Crimson Coyotes vs Magenta Marauders (7:00)",
//       Monday: "No Matches",
//       Tuesday: "No Matches",
//       Wednesday: "Onyx Owls vs Amber Falcons (7:30)",
//       Thursday: "No Matches",
//       Friday: "Ivory Irons vs Golden Griffins (6:00)",
//       Saturday: "Emerald Eagles vs Thunderbolts (8:00)",
//     },
//     "Week 2": {
//       Sunday: "Thunderbolts vs Red Rockets (6:30)",
//       Monday: "Blue Blazers vs Ivory Irons (5:00)",
//       Tuesday: "Golden Griffins vs Onyx Owls (7:30)",
//       Wednesday: "No Matches",
//       Thursday: "Bronze Bears vs Silver Sharks (6:30)",
//       Friday: "Amber Arrows vs Magenta Marauders (5:30)",
//       Saturday: "Crimson Coyotes vs Blue Blazers (7:00)",
//     },
//     "Week 3": {
//       Sunday: "Golden Griffins vs Ivory Irons (6:00)",
//       Monday: "No Matches",
//       Tuesday: "Onyx Owls vs Blue Blazers (5:30)",
//       Wednesday: "Thunderbolts vs Red Rockets (7:00)",
//       Thursday: "Ivory Irons vs Bronze Bears (6:30)",
//       Friday: "Crimson Coyotes vs Amber Arrows (7:30)",
//       Saturday: "No Matches",
//     },
//   };

//   // **Dummy reschedule slots data**
//   const rescheduleSlots = {
//     "Week 1": {
//       Sunday: [],
//       Monday: ["9:30 PM | Field 1", "9:30 PM | Field 3"],
//       Tuesday: ["5:00 PM | Field 1", "9:30 PM | Field 3"],
//       Wednesday: ["6:30 PM | Field 1", "8:00 PM | Field 3"],
//       Thursday: ["5:30 PM | Field 1", "9:30 PM | Field 3"],
//       Friday: ["6:30 PM | Field 1", "8:00 PM | Field 3"],
//       Saturday: [],
//     },
//     "Week 2": {
//       Sunday: ["6:00 PM | Field 2", "8:00 PM | Field 4"],
//       Monday: ["5:30 PM | Field 1", "7:30 PM | Field 3"],
//       Tuesday: [],
//       Wednesday: ["9:00 PM | Field 2"],
//       Thursday: ["6:30 PM | Field 1", "7:30 PM | Field 3"],
//       Friday: ["5:30 PM | Field 1"],
//       Saturday: ["8:00 PM | Field 3"],
//     },
//     "Week 3": {
//       Sunday: ["5:30 PM | Field 1"],
//       Monday: [],
//       Tuesday: ["6:30 PM | Field 1", "8:30 PM | Field 3"],
//       Wednesday: ["7:00 PM | Field 2"],
//       Thursday: [],
//       Friday: ["5:30 PM | Field 1", "9:00 PM | Field 3"],
//       Saturday: [],
//     },
//   };

//   // **Determine which week's data to show**
//   const weekNumber = `Week ${Math.ceil(currentDate.getDate() / 7)}`; // Approximate week number
//   const scheduleData = matchData[weekNumber] || {};
//   const rescheduleData = rescheduleSlots[weekNumber] || {};
...
//             <p style={styles.eventText}>{scheduleData[date.day] || "No Matches"}</p>
//           </div>
//         ))}
//       </div>
...
//               {rescheduleData[date.day]?.length > 0 ? (
//                 rescheduleData[date.day].map((slot, slotIndex) => (
