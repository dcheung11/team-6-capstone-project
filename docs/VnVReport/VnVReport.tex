    ...
    \item \textbf{FR-2}
       ...
       \item \textbf{FR-3}
          \begin{itemize}
              ...
              \item How Test Will be Performed: Tester will attempt to create a new team suing a duplicate \textt{TeamName}. Verify that the team is not added to the database.
