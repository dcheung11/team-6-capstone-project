...
\begin{itemize}
    ...
    \item \textbf{Announcements} (Requirement \#9, \#10): Commissioners post league-wide announcements for all users.
\end{itemize}
...
Development will be divided into phases, with each phase focused on implementing the functional requirements in order of priority. Each phase includes relevant milestones:

\subsubsection{Phase 1: Requirement Gathering and Initial Planning}
\textit{Milestones Included:} Problem Statement, POC Plan, Development Plan, Requirements Document Revision 0
\begin{itemize}
...
\textit{Milestones Included:} Hazard Analysis 0, V\&V Plan Revision 0, Proof of Concept Demonstration
\begin{itemize}
    ...
    \item Finalize the design document and refine based on stakeholder feedback.
\end{itemize}

\subsubsection{Phase 3: Core Development}
\textit{Milestones Included:} Design Document Revision 0
\begin{itemize}
...
\textit{Milestones Included:} Revision 0 Demonstration, V\&V Report Revision 0
\begin{itemize}
...
\textit{Milestones Included:} Final Demonstration (Revision 1), EXPO Demonstration
\begin{itemize}
...
\textit{Milestones Included:} Final Documentation (Revision 1)
\begin{itemize}
