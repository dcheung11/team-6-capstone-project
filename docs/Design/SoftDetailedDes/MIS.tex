...
\begin{tabularx}{\textwidth}{p{3cm}p{2cm}X}
  ...
  Jan 14              & 1.1          & Added MIS for Season and Standing Record Modules           \\
  Jan 17              & 1.2          & Added sections 2,3,4                                        \\
  \bottomrule
\end{tabularx}
...
Pitch Perfect McMaster GSA Softball League Platform, a web application for managing the McMaster GSA Softball League.  
