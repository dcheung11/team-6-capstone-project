...
\begin{center}
  \begin{tabularx}{\textwidth}{|l|X|X|X|}
    ...
    \textbf{Name}    & \textbf{In}                                   & \textbf{Out} & \textbf{Exceptions}                            \\
    \hline
    reportScore      & int: gameID, int: team1Score, int: team2Score & bool: status & InvalidGameIDException, InvalidScoreException  \\
    \hline
    updateGameStatus & int: gameID, string: newStatus                & bool: status & InvalidGameIDException, InvalidStatusException \\
    \hline
    getGameDetails   & int: gameID                                   & GameT: game  & InvalidGameIDException                         \\
    \hline
  \end{tabularx}
\end{center}
...
\begin{itemize}
  \item \texttt{games}: A mapping of game IDs to game details, including participating teams, scores, and statuses.
\end{itemize}
...
\begin{itemize}
  ...
  \item UI Module: For allowing users to report scores and update statuses.
\end{itemize}
...
\begin{itemize}
  ...
  \item Input data (scores and statuses) are provided in the correct format.
\end{itemize}
...
\begin{itemize}
  \item transition: Updates the scores for the game identified by \texttt{gameID}.
  \item output: Returns success or failure status.
...
\begin{itemize}
  \item transition: Changes the status of the game identified by \texttt{gameID}.
  \item output: Returns success or failure status.
...
\noindent \texttt{retrieveGameResults}(gameID):
\begin{itemize}
  \item output: Returns the game details, including scores and status.
