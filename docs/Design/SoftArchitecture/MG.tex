...
The team management view enables captains to manage their rosters, invite players, and view team details.
...
The scheduling view allows users to view and manage game schedules, including the ability to request rescheduling.
...
The announcements view is used by commissioners to communicate league-wide updates and notifications.

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{announcementpage.png}
