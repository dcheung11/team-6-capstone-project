...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.22]{LeagueHomeView.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.25]{TeamHomeView.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.25]{TeamScheduleView.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.25]{StandingsView.png}
